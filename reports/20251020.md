...
### Progress and Issues
- Finalized data flow and basic auth featuers / functionality
- Set up Firebase and configured for backend
- Did not yet get to coding up the authentication cause didn't end up having time this weekend
### Plans and Goals for the Next Week
- Implement the authentication log in and sign up features (3 days)
- Coorperate with frontened to deliver best results (2 days)
